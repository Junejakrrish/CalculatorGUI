...
btn_mult=tk.Button(root,text="*",command=lambda:add_to_calculation("*"),width=5,font=("Arial"))
...
btn_clear=tk.Button(root,text="clear",command=clear_field,width=5,font=("Arial"))
btn_clear.grid(row=6,column=1)
btn_equal=tk.Button(root,text="=",command=evaluate_calculation,width=5,font=("Arial"))
